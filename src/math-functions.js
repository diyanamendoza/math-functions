...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    let firstElProd = (multiply((multiply(aa, bb)[0]), cc))[0];
    let secElStringy = `The numbers ${aa},${bb},${cc} have a product of ${firstElProd}.`;
    myArray.push(firstElProd, secElStringy);
    return myArray;
}
...
Write a function called multiplyAnyArray() that takes an array of numbers of any length as its argument and returns an array whose 
first element is the product of those numbers, and the second element is a string that EXACTLY follows this example and concatenates a 
...
//     }
//     return finalArray.push(result, `The numbers ${dynamicArray} have a product of ${result}`);
// }
